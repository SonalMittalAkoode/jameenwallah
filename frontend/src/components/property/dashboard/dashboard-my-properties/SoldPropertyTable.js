          ...
          <tr key={property.id}>
                ...
                <div className="list-content py-0 p-0 mt-2 mt-xxl-0 ps-xxl-4">
                  <div className="h6 list-title">
                    <Link href={getPropertyHref(property)}>
                      {property.title}
                      <span className="badge bg-success ms-2" style={{ fontSize: "11px" }}>SOLD</span>
                    </Link>
                  </div>
            ...
            <td className="vam">
              <div className="d-flex">
                <Link
                  href={`/cmsadminlogin/sold-property/edit/${property.id}`}
                  className="icon"
...
export default SoldPropertyTable;
