...
const EnquirySubmissionTable = ({ enquiries, loading, error, onRetry }) => {
            ...
            {paginatedData.length > 0 ? (
              paginatedData.map((enquiry) => (
                <tr key={enquiry._id || enquiry.id}>
                  ...
                  <td style={{ textAlign: "left", maxWidth: "400px", wordWrap: "break-word" }}>
                    <div
                      className="list-title mb-0"
                      style={{
                        whiteSpace: "normal",
                  ...
                  <td style={{ textAlign: "left" }}>
                    <div className="list-title mb-0">
                      {enquiry.scheduledDate ? formatDate(enquiry.scheduledDate) : "—"}
                    </div>
                  </td>
                  <td style={{ textAlign: "left" }}>
                    <div className="list-title mb-0">
                      {enquiry.scheduledTime || "—"}
                    </div>
                  </td>
                  <td style={{ textAlign: "left" }}>
                    <div className="list-title mb-0">
...
export default EnquirySubmissionTable;
