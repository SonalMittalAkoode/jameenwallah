...
const BankerEnquiryTable = ({ enquiries, loading, error, onRetry }) => {
            ...
            {paginatedData.length > 0 ? (
              paginatedData.map((enquiry) => (
                <tr key={enquiry._id || enquiry.id}>
                  ...
                  <td style={{ textAlign: "left" }}>
                    <div className="list-title mb-0">
                      {formatEmploymentType(enquiry.employmentType)}
                    </div>
                  </td>
                  <td style={{ textAlign: "left" }}>
                    <div className="list-title mb-0">
                      {formatLoanType(enquiry.loanType)}
                    </div>
                  </td>
...
export default BankerEnquiryTable;
