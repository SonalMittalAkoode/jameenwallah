...
const ConsultancyEnquiryTable = ({ enquiries, loading, error, onRetry }) => {
        ...
        <table className="table-style3 table at-savesearch">
          <thead className="t-head">
            <tr>
              ...
              <th scope="col" style={{ textAlign: "left" }}>Requirement</th>
              <th scope="col" style={{ textAlign: "left" }}>Service Page</th>
              ...
              paginatedData.map((enquiry) => (
                <tr key={enquiry._id || enquiry.id}>
                  <td style={{ textAlign: "left" }}>
                    <div className="h6 list-title mb-0">{enquiry.fullName || "—"}</div>
                  </td>
                  <td style={{ textAlign: "left" }}>
                    <a
                      href={enquiry.phoneNumber ? `tel:${enquiry.phoneNumber}` : undefined}
                  ...
                  <td style={{ textAlign: "left", maxWidth: 240 }}>
                    <div className="list-title mb-0" style={{ wordBreak: "break-word" }}>
                      {enquiry.email || "—"}
                    </div>
                  </td>
                  <td style={{ textAlign: "left" }}>
                    <div className="list-title mb-0">{enquiry.issuetype || "—"}</div>
                  </td>
                  <td style={{ textAlign: "left" }}>
                    <div className="list-title mb-0">
                      {normalizeAccountType(enquiry.accounttype)}
                    </div>
                  </td>
...
export default ConsultancyEnquiryTable;
