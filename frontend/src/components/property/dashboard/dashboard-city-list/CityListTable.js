...
import { getAllCities, deleteCity } from "@/api/city";
...
const CityListTable = () => {
  ...
  }, [searchTerm, statusFilter, cities, currentPage]);
  ...
  if (error) {
    return (
      <div className="text-center py-4">
        ...
        <button className="ud-btn btn-thm mt-3" onClick={fetchCities}>
          Retry
        </button>
      </div>
    );
            ...
            <tr key={city._id}>
                ...
                <div className="d-flex align-items-center gap-3">
                  ...
                  >
                    {city.image ? (
                      ...
                      >
                        {city.name?.[0]?.toUpperCase() || "C"}
                      </div>
                    )}
                  </div>
                  <div>
                    <div className="h6 list-title mb0">{city.name}</div>
                    <p
                      className="text mb0"
                      style={{
                        color: "#6c757d",
                    ...
                    >
                      {city.state?.name || "No state assigned"}
                    </p>
                  </div>
                </div>
              </th>
              <td style={{ textAlign: "left" }}>
                <div className="list-title">{city.state?.name || "N/A"}</div>
              </td>
              ...
              <td className="vam" style={{ textAlign: "left" }}>
                <span
                  style={{
                    backgroundColor:
                      city.status === "active" ? "#28a745" : "#6c757d",
                    color: "#ffffff",
                    padding: "4px 12px",
                    borderRadius: "4px",
                    fontSize: "12px",
              ...
              <td className="vam" style={{ textAlign: "right" }}>
                <div className="d-flex justify-content-end gap-2">
                  <Link
                    href={`/cmsadminlogin/add-city?editId=${city._id}`}
                    className="icon"
                    style={{
                      border: "none",
                      background: "none",
                  ...
                  <button
                    ...
                    data-tooltip-id={`delete-${city._id}`}
