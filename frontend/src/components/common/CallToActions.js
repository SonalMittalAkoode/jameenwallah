...
const CallToActions = () => {
  return (
    <section className="our-cta pt0">
      <div className="cta-banner bgc-f7 mx-auto maxw1600 pt80 pt30-md pb80 pb30-md bdrs12 position-relative mx20-lg">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-5 col-xl-6 " data-aos="fade-left">
              <div className="cta-btns-style1 d-block d-sm-flex align-items-center justify-content-lg-end">
                ...
                <ScheduleCallPopover
                  triggerClassName="ud-btn btn-dark schedule-call-cta-btn"
                  triggerLabel="Schedule Call"
                  triggerIconClass="flaticon-call vam pe-2"
                />
              </div>
            </div>
            {/* End col-lg-5 */}
